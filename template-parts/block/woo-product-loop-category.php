...
$icon_check_html = Icons_Manager::render_font_icon(
    array("value" => "fas fa-check",
        "library" => "fa-solid"
    ),
    array("aria-hidden" =>
        "true"
    ...
    "svg ");
$icon_prev_html = Icons_Manager::render_font_icon(
    array("value" => "fas fa-long-arrow-alt-left",
        "library" => "fa-solid"
    ),
    array("aria-hidden" =>
        "true"
    ...
    "svg ");
$icon_next_html = Icons_Manager::render_font_icon(
    array("value" => "fas fa-long-arrow-alt-right",
        "library" => "fa-solid"
    ),
    array("aria-hidden" =>
        "true"
...
$label_color = get_field('product_label_color', $id);
$title = get_field('long_title_product', $id) ?: str_replace('Wifi', '<sup>wifi</sup>', get_the_title($id));
...
foreach ($product->get_attributes() as $attribute) {
    ...
    echo "{$attribute->get_name()}='{$value}' ";
} ?> >
    <div class="product_col__image">
        ...
        <?php if (get_field('lot20_compliant', $id)): ?>
            <div class="product__lot20">
                <div class="product__lot20__wrap">

                    <?php echo '<img class="lot20__img" src="' . get_stylesheet_directory_uri() . '/img/european-lot20-compliant-icon.svg" alt="LOT20" width="17" height="30" loading="lazy" />'; ?>

                    <span class="product__lot20__title">LOT20</span>
                </div>
                <span class="product__lot20__desc">Ecodesign Compliant</span>
        ...
        if ($product_features_keys) : ?>
            <ul class="product__features-list">
                <?php foreach ($product_features_keys as $key => $post) : ?>
                    <li class="list__item">
                        <?php echo $post['product_ksps_list_item']; ?>
                    </li>
                <?php endforeach; ?>
            </ul>
        <?php endif; ?>
                            ...
                            if (!empty($area)) {
                                $data .= '<div class="cvy_property_field_wrapper cvy_property_area">
                                            <div class="cvy_property_field">
                                                ...
                                                <div class="cvy_tip">
                                                    <a href="javascript:void(0);" class="cvy_insulation_info" title="Room Size">i</a>
    ...
    <div class="product_col__price">
        <div class="product_col__price_col">
            <div class="product_col__price_col-1">
                ...
                <div class="product__payLater__icons">
            ...
            <div class="product_col__price_col-2">
                <div class="product__delivery">

                    <?php echo $icon_check_html; ?>
                ...
                <a class="product__button" href="<?php echo get_the_permalink($id) ?>">
                    <?php _e('Buy Now'); ?>
                </a>
                <a class="product__learnMore" href="<?php echo get_the_permalink($id) ?>">
                    <?php _e('Learn more'); ?>
                </a>
            </div>
        </div>
        <div class="product__deliveryFooter">
            <svg xmlns="http://www.w3.org/2000/svg" id="Delivery_icon" data-name="Delivery icon"
                 width="44"
                 height="44" viewBox="0 0 44 44">
                <circle id="Ellipse_458" data-name="Ellipse 458" cx="22" cy="22" r="22"
                        fill="#fff"></circle>
