                ...
                if ($attribute == "pa_wattage") {
                    ...
                    foreach ($variations as $key => $variation) {
                        ...
                        if (isset($variation['attributes']["attribute_pa_el_type"])) {
                            ...
                            $data .= sprintf('<li class="cvy_variation_list_item variable-item dropdown-variable-item dropdown-variable-item-%3$s %4$s no-match out-stock-%8$s" title="%5$s" data-value="%3$s" data-attribute_pa_colour="%6$s" data-attribute_pa_el_type="%7$s"  data-is_in_stock="%8$s"  data-full_src="'.get_the_post_thumbnail_url($variation_id,'full').'" data-src="'.get_the_post_thumbnail_url($variation_id,'woocommerce_single_crop').'" data-thumb_src="'.get_the_post_thumbnail_url($variation_id,'woocommerce_gallery_thumbnail').'"  role="button" tabindex="0">', '', '', $variation['attributes']['attribute_pa_wattage'], esc_attr($selected_class), $variation['attributes']['attribute_pa_wattage'], $variation['attributes']['attribute_pa_colour'], $variation['attributes']["attribute_pa_el_type"], (!$variation["is_in_stock"]) ? 'yes' : 'no');

                        } else if (isset($variation['attributes']["attribute_pa_control-type"])) {

                            $data .= sprintf('<li class="cvy_variation_list_item variable-item dropdown-variable-item dropdown-variable-item-%3$s %4$s no-match out-stock-%8$s" title="%5$s" data-value="%3$s" data-attribute_pa_size="%6$s" data-attribute_pa_el_type="%7$s"  data-is_in_stock="%8$s"  data-full_src="'.get_the_post_thumbnail_url($variation_id,'full').'" data-src="'.get_the_post_thumbnail_url($variation_id,'woocommerce_single_crop').'" data-thumb_src="'.get_the_post_thumbnail_url($variation_id,'woocommerce_gallery_thumbnail').'"  role="button" tabindex="0">', '', '', $variation['attributes']['attribute_pa_wattage'], esc_attr($selected_class), $variation['attributes']['attribute_pa_wattage'], $variation['attributes']['attribute_pa_size'], $variation['attributes']["attribute_pa_control-type"], (!$variation["is_in_stock"]) ? 'yes' : 'no');

                        } else {

                            $data .= sprintf('<li class="cvy_variation_list_item variable-item dropdown-variable-item dropdown-variable-item-%3$s %4$s no-match out-stock-%7$s" title="%5$s" data-value="%3$s" data-attribute_pa_colour="%6$s"   data-is_in_stock="%7$s" data-full_src="'.get_the_post_thumbnail_url($variation_id,'full').'" data-src="'.get_the_post_thumbnail_url($variation_id,'woocommerce_single_crop').'" data-thumb_src="'.get_the_post_thumbnail_url($variation_id,'woocommerce_gallery_thumbnail').'"   role="button" tabindex="0">', '', '', $variation['attributes']['attribute_pa_wattage'], esc_attr($selected_class), $variation['attributes']['attribute_pa_wattage'], $variation['attributes']['attribute_pa_colour'], (!$variation["is_in_stock"]) ? 'yes' : 'no');
