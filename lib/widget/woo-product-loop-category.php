       ...
       ;
        ...
        <style>
            ...
            @media screen and (max-width: 756px) {
                ...
                .product_cat_electricRadiators__main .product__label, .product_cat_electricRadiators__main .product_titleMob, .product_cat_electricRadiators__main .product__reviews {
                    order: 0;
                }
